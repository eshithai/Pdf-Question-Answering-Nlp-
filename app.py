...
def main():
    ...
    st.markdown("""
        <style>
        body {
            background-image: url('D:/NITHUSHREE COURSE/MSRIT/2 Sem/NLP/Project/Gemini-PDF-Question-Answering-System/the-illustration-graphic-consists-of-abstract-background-with-a-blue-gradient-dynamic-shapes-composition-eps10-perfect-for-presentation-background-website-landing-page-wallpaper-vector.jpg');
